...
*/
        ...
        $metin[24]="Þimdilik Parola G&uuml;ncelleme";           
...
";
		...
		$metin[168]="Hýzlý Konu Arama";
		$metin[169]="Sýnýrlý &Ccedil;alýþma S&uuml;resi";
		$metin[170]="Soru Kalan Zamaný";
		$metin[171]="dakika";
		$metin[172]="saniye";
		...
		$metin[211]="Yetim Kayýt Listesi (tablo ve indeks boyutlarý toplamý Byte, eðer varsa taþma bilgisi Byte)"; 
		$metin[212]="iliþkisiz";
		$metin[213]="Son &ccedil;alýþmalarýnýz";
		
		$metin[214]="Sýnýf kýsýtlamasý vardýr.";
		
        $metin[215]="Tablolara <strong>bakým ve tamir</strong> iþlemleri i&ccedil;in <input type='button' onclick='location.href = &quot;siteSettings2.php?optim=1&quot;;' value=\"t&#305;klat&#305;n&#305;z\"/>";   
		...
		$metin[221]="Sýnýfý silinmiþ dersler";
		$metin[222]="Konuda problem yoktur";
		$metin[223]="Dersi silinmiþ konular";
		$metin[224]="&Ouml;nceki konuda problem yoktur";
		$metin[225]="&Ouml;nceki konudan problemler";
		$metin[226]="Sayfada problem yoktur";
		$metin[227]="Konusu silinmiþ sayfalar";
		$metin[228]="Ekleyen kullanýcýda problem yoktur";
		$metin[229]="Ekleyen kullanýcýdan problemler";
		$metin[230]="Kullanýcýda problem yoktur";
		$metin[231]="Varolmayan kullanýcýlar (demo kabul edilir)";
		$metin[232]="Konuda problem yoktur";
		$metin[233]="Konuda problemler";
		$metin[234]="Kullanýcýda problem yoktur";
		$metin[235]="Varolmayan kullanýcýlar";
		$metin[236]="Sýnýfta problem yoktur";
		...
		$metin[245]="Bu S&uuml;reden Az &Ccedil;alýþmalarý G&ouml;zardý Et (saniye)";				
		$metin[246]="Varsayýlan";				
		$metin[247]="<img src=\"img/tip.gif\" border=\"0\" style=\"vertical-align:middle\" alt=\"imp\" title=\" %d saniyeden az olan &ccedil;alýþmalar g&ouml;zardý edilir.\"/>";					
...
Detaylar için <a href=\"INSTALL.html\">týklatýnýz</a>.
		...
		$metin[275]="Oy kullandýðýnýz i&ccedil;in teþekk&uuml;r ederiz.";
		
		$metin[276]="Oy oranlarý";
		$metin[277]="En fazla yorum eklenenler";
		
		$metin[278]="Ýlk oyu siz kullanýn.";
		$metin[279]="Ýlk yorumu siz ekleyin.";
		
		$metin[280]="Ger&ccedil;ek adýnýz ve soyadýnýzý giriniz. <br/>En az 5, en fazla 30 harf olabilir.<br/><strong>Boþ ge&ccedil;ilemez.</strong>";
		$metin[281]="Kullanýcý adýnýzý giriniz. <br/>En az 5, en fazla 15 harf olabilir. Ýzin verilen karakterler a-z A-Z 0-9. Boþluk ve Ýngilizce olmayan karakterlere izin verilmez.<br/><strong> Boþ ge&ccedil;ilemez.</strong>";
		$metin[282]="Parolanýzý giriniz. <br/>En az 5, en fazla 15 karakter olabilir. Ýzin verilen karakterler a-z A-Z 0-9. Boþluk ve Ýngilizce olmayan karakterlere izin verilmez<br/> <strong>Boþ ge&ccedil;ilemez.</strong>";
		$metin[283]="Parolanýzý tekrar giriniz. <br/>En az 5, en fazla 15 karakter olabilir. Ýzin verilen karakterler a-z A-Z 0-9. Boþluk ve Ýngilizce olmayan karakterlere izin verilmez<br/> <strong>Boþ ge&ccedil;ilemez.</strong>";
		...
		$metin[298]="Ders";
		$metin[299]="Konu";
		$metin[300]="&Ccedil;alýþmaz ise Ctrl+D kýsayoluna basabilirsiniz";		
		...
		$metin[311]="Mini Profilimi Göster"; 	
		$metin[312]="Mini Profil";
		$metin[313]="Son Giriþ Tarihi";
		$metin[314]="Dahil Olunan Sýnýflar";
		$metin[315]="Giriþ Sayýsý";
		$metin[316]="Ders Çalýþma Sayýsý";
		$metin[317]="Ders Çalýþma Süresi";
		$metin[318]="Ders Bitirme Yüzdesi";
		$metin[319]="Sayfa Ekleme Sayýsý";
		$metin[320]="Yorum Sayýsý";
		$metin[321]="Onaylanmamýþ Yorum Sayýsý";
		$metin[322]="Oy Verme Sayýsý";
		$metin[323]="Ortalama";	
		$metin[324]="Sýra";	
		
		$metin[325]="Çalýþma hak sayýsý";
		$metin[326]="Sýnýfa dahil kullanýcýlar görebilir";
		$metin[327]="Konu Bilgisi";
		$metin[328]="Ders Adý (Okul - Sýnýf)";	
		$metin[329]="Sayfa Sayýsý";	
		$metin[330]="Son çalýþma tarihi";	
		$metin[331]="Son Güncellenme Tarihi";
		$metin[332]="Çalýþýlma Sayýsý";
		$metin[333]="Çalýþýlma Süre Toplamý";	
		$metin[334]="Bitirilme Ortalamasý";	
		$metin[335]="Oy Oraný";	
		$metin[336]="Yorum Sayýsý";
		$metin[337]="Onaysýz Yorum Sayýsý";
		$metin[338]="Konu Kýsýtlamalarý";	
		$metin[339]="Derse Git";	
    ...
    <p>Yeni fikir ve önerilerinizi göndermek isterseniz <br/>
	  ...
	  <font color='red'><strong>Öðrenciler sadece RAR uzantýlý dosya gönderebilir.</strong></font>";
		...
		$metin[534] = "Sitenin tekrar kullanýma açýlmasý için siteUnlockPwd parolasý kullanýlabilir.";
		...
		$metin[550] = "%s bugün, %s dün ve %s daha önceki gün aktivite vardýr.";
		$metin[551] = "Genel";
		$metin[552] = "Basit";
		$metin[553] = "Tam Ekran";
		...
		$metin[621]	= "gün";
		$metin[622]	= "bugün";
		$metin[623]	= "Veli, öðrenci ve öðretmenlerimiz ders çalýþmalarýný buradan takip edebilirler";
		...
		$metin[658] = "Öðrencilik";
		$metin[659] = "Öðretmenlik";
		...
		$metin[675] = "Son çalýþýlan konular";
		$metin[676] = "Eklemek için bu kodu kopyalayýnýz";
