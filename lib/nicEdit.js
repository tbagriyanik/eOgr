...
var nicUploadOptions = {
	buttons : {
		'upload' : {name : 'Upload Image (Resim Gönder)', type : 'nicUploadButton'}
	}
...
//	nicURI : 'lib/ajaxupload/upload.php',
	nicURI : 'lib/nicEdit.php',
	...
	addForm : function() {
		...
		if(this.uri == this.nicURI) {
			myDoc.write('<div style="position: absolute; margin-left: 220px;margin-top: 1px;"><div style="float: left; margin-left: 5px; font-size: 10px;"><br /></div></div>');
		}
		myDoc.write('<div style="font-size: 14px; font-weight: bold; padding-top: 5px;">Insert an Image (Resim Gönder)</div>');
	...
	startUpload : function() {
		...
		this.myStatus.setContent('<img src="img/ajax-loader.gif" style="float: right; margin-right: 40px;" /><strong>Uploading...</strong><br />Please wait');
		this.myForm.submit();
	...
	update : function(o) {
		if(o == false) {
			...
			if(this.im) {				
				this.im.setAttributes({
					src : "fileDownload.php?file="+o.url+"&islem=goster&id="+o.id,
