...
/*
bitirmeYuzdesi:
ders &ccedil;al&#305;&#351;mada ilerleme &ccedil;ubuðunun deðerinin bulunmas&#305;
*/
...
/*
sureDolduTemizle:
genel olarak ders sayfas&#305;ndaki böl&uuml;mlerin temizlenmesi
*/
function sureDolduTemizle(){
        ...
        document.getElementById('anaMetin').innerHTML =   "<font id='hata'>Öz&uuml;r dileriz, s&uuml;reniz dolmu&#351; veya sayfa ge&ccedil; y&uuml;kleniyor olabilir.<p>Sayfay&#305; <a href='lessons.php?konu="+document.getElementById('konu_id').value+"'>yenilemeyi</a> deneyiniz veya <a href='index.php'>oturum</a> a&ccedil;&#305;n&#305;z.</p></font>";          
	...
	if(noCount === undefined) noCount=0;
		...
		if (kayitSayisi>0) {
			...
			if (sayfaNo>=kayitSayisi) 	{
				...
				//konu se&ccedil;ili ise hint gösterilebilir!
			...
			timeoutId = window.setTimeout(function() { 
			 ...
			 if(httpObject.readyState == 4)
				 if(httpObject.status == 200 || httpObject.status == 304){			
					...
					//deðerlerin i&#351;lenmesi i&ccedil;in alt programa gidelim
...
/*
saveUserWork:
ders bittiðinde kullan&#305;c&#305;ya ders bilgisinin kaydedilmesi
*/
...
/*
cevapDegerlendir:
gelen cevap deðerinin veritaban&#305;ndan kar&#351;&#305;la&#351;t&#305;r&#305;lmas&#305;
*/
...
/*
cevapDegerlendir2:
gelen cevap deðerinin veritaban&#305;ndan kar&#351;&#305;la&#351;t&#305;r&#305;lmas&#305;, MULTIPLE CHOICE
*/
...
/*
trim:
sað ve soldaki bo&#351;luklar&#305; siler
*/
...
/*
loginDurumu:
kay&#305;tl&#305; kullan&#305;c&#305;lar i&ccedil;in oturum a&ccedil;&#305;k olduðunun kontrol edilmesi
*/
