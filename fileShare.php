     ...
     GetSQLValueString($_POST['fileName'], "text")=='NULL'  	 
	   ...
	   echo "<font id='hata'>Bilgilerinde eksik alanlar vardır.</font>";
		  ...
		  if($Result1) {
				...
				echo ("<font id='tamam'> Bilgi g&uuml;ncelleme işleminiz tamamlandı!</font>");
		    }
			else {
...
return false;" class="external">Dosya Paylaş</a>
</blockquote>
<?php
...
if ($totalRows_eoUsers==0) echo "<font id='hata'> Arama sonucuna uyan bilgi bulunamadı veya hi&ccedil; kayıt yok!</font><br/>Geri d&ouml;nmek i&ccedil;in <a href=fileShare.php>tıklatınız</a>";
