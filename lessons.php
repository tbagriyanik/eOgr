...
?>
                  ...
                  <div id="navigation"><span id="konuAdi">-</span> <span id="aktifKonuNo" style="visibility:hidden"></span><br />
                    ...
                    <form name="sunum" style="text-align:right">
                      ...
                      <input type="checkbox" id="sunuDurdur" name="sunuDurdur" title="Seçili ise sunum durur, seçili değil ise sunum devam eder."
                    value="1" onclick="
...
/*
konuDuzenle:
konu düzenleme bağının çalışması
*/
