     ...
     GetSQLValueString($_POST['description3'], "text")=='NULL' 
	   ...
	   echo "<p>&nbsp;</p><font id='hata'>Haber bilgilerinde eksik alanlar vardır.</font>";
		  ...
		  if($Result1) {
				...
				echo ("<p>&nbsp;</p><font id='tamam'> Haber bilgilerini g&uuml;ncelleme işleminiz tamamlandı!</font>");
		    }
			else {
     ...
     GetSQLValueString($_POST['language'], "text")=='NULL' 
	   ...
	   echo "<p>&nbsp;</p><font id='hata'>Haber ayar bilgilerinde eksik alanlar vardır.</font>";
		  ...
		  if($Result1) {
				...
				echo ("<p>&nbsp;</p><font id='tamam'> Haber ayar bilgilerini g&uuml;ncelleme işleminiz tamamlandı!</font>");
		    }
			else {
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
 if ( 
  ...
  if ($Result1) {
			  ...
			  echo "<p>&nbsp;</p><font id='tamam'> Yeni haber ekleme işleminiz tamamlandı!</font>";
  }
  else{
...
if ((isset($_GET['id'])) && ($_GET['id'] != "") && ($_GET['delCon'] == "1")) {
 ...
 if ($Result1) {
			  ...
			  echo "<p>&nbsp;</p><font id='uyari'> Haber silme işleminiz tamamlandı!</font>";
  }
  else{
