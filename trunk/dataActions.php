...
if(!empty($_POST["sil"]) && $_POST["silIzin"]=="evet") {
   ...
   for ($i = 0; $i < count($_POST["sil"]); $i++)
	...
	if ($sonuc) echo "<font id='uyari'>Se&ccedil;ilen kayıt(lar) silinmiştir!</font>";
 }   
...
if ($totalRows_eoUsers==0) echo "<font id='hata'> Arama sonucuna uyan bilgi bulunamadı veya hi&ccedil; kayıt yok!</font><br/>Geri d&ouml;nmek i&ccedil;in <a href=dataActions.php>tıklatınız</a>";
