...
?>
		...
		if(istekteBulunanSay()>0)
			printf("<p>%s adet <strong>yetki</strong> değiştirme isteğini görmek için <a href=\"dataActions.php?arama=request,\" title=\"istekler\">tıklatınız</a>.<br/>Üye yetkisini üye düzenleyerek yapabilirsiniz veya reddetmek için isteği silebilirsiniz.</p>",istekteBulunanSay());	
}
