                        ...
                        <td valign="top" style="background-color:#FFF !important"><ul>
                            <li><img src="img/user_manager.gif" border="0" style="vertical-align: middle;" alt="<?php echo $metin[551]?>"/> <?php echo $metin[551]?>
                              <ul style="list-style:none">
                                ...
                                <li><img src="img/course.gif" border="0" style="vertical-align:middle;" alt="kurs" /> <a href="kursDetay2.php"><span><span> <?php echo $metin[461]?> </span></span></a></li>
                          ...
                          <ul style="list-style:none">
                            <li><img src="img/ogr_user.png" border="0" style="vertical-align: middle;" alt="<?php echo $metin[94]?>"/> <?php echo $metin[94]?>
                              <ul style="list-style:none">
                                ...
                                <li><img src="img/course.gif" border="0" style="vertical-align:middle;" alt="kurs" /> <a href="kursDetay.php"><span><span> <?php echo $metin[461]?></span></span></a></li>
