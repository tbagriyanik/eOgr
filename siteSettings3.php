  ...
  if($_POST['ayar5char17']=="1") {
	 ...
	 echo "<font id='tamam'> Paylaşım klasörü salt okunur.</font>";
		  ...
		  if($Result1) {
				...
				echo ("<font id='tamam'> Site bilgilerini g&uuml;ncelleme işleminiz tamamlandı!</font>");
		    }
			else {
...
?>
                  ...
                  * Siteyi bakıma almanın 2. yöntemi, "siteLock.php" dosyasının adını elle değiştirmektir. <br />
                  Siteyi <strong>bakıma</strong> almak için "_siteLock.php" dosyasının adını "siteLock.php" olarak değiştiriniz.<br />
                    Siteyi <strong>aktif</strong> yapmak için "siteLock.php" dosyasının adını "_siteLock.php" olarak değiştiriniz.</p>
                  <?php
	}
	...
	if(substr(sprintf('%o', fileperms($_uploadFolder)), -4)=="0755"){
		...
		echo "<p>* <strong>$_uploadFolder</strong> dizini fiziksel olarak <strong>yazılabilirdir</strong>.</p>";
	}
?>                          
                        </div>
                        <div class="cleared"></div>
