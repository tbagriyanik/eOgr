                    ...
                    <table border="0" cellpadding="3" cellspacing="0" align="center">
                      <tr>
                        ...
                        <th width="220" nowrap="nowrap"><?php if ($sirAlan=="konuAdi") {?>
                          ...
                          <?php } ?>
                          <a href="lessonsEdit.php?sirAlan=konuAdi&amp;tab=3&amp;siraYap=OK"><?php echo $metin[364] ?> (Sayfa Sayısı)</a></th>
                        <th width="396" nowrap="nowrap"><?php if ($sirAlan=="dersAdi") {?>
                          <img src="img/<?php echo ($siraYonu=="desc" && $sirAlan=="dersAdi")?"desc":"asc"?>.png" alt="S&#305;ralama Y&ouml;n&uuml;" border="0" style="vertical-align: middle;"/>
                          <?php } ?>
                          <a href="lessonsEdit.php?sirAlan=dersAdi&amp;tab=3&amp;siraYap=OK"><?php echo $metin[363] ?> (Okul - Sınıf)</a></th>
                      </tr>
                      <?php
		...
		if(isset($_GET["id"])) $seciliKayit=temizle($_GET["id"]); else $seciliKayit=-1;
		  ...
		  $result2 = mysql_query($sql2, $yol);
			...
			if ($seciliKayit!="") {
				...
				echo "Bu konuyu &ouml;nizlemek i&ccedil;in <a href='lessons.php?konu=$seciliKayit'><img src=\"img/preview.png\" border=\"0\" style=\"vertical-align: middle;\"  alt=\"preview\"/> t&#305;klat&#305;n&#305;z</a>. Konudaki sayfaları düzenlenmesi i&ccedil;in <a href='lessonsEdit.php?tab=4&amp;seciliKonu=$seciliKayit'> t&#305;klat&#305;n&#305;z</a>.<br/><br/>";
			}
