...
?>
                    ...
                    <form action="lessonsEdit.php" method="post" name="konuKim" id="konuKim">
                      ...
                      <br/>Bir konuda düzenleme yapmak için bir sayfa düzenlemeniz yeterlidir. Bu sayede o konu sizin düzenlediğiniz konularda çıkacaktır. 
                    </form>
                    <br/>
...
?>
                    <script language="JavaScript" type="text/javascript" src="lib/jquery-ui-1.8.4.custom.min.js"></script> 
