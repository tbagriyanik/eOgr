...
if ((isset($_POST["MM_settings"])) && ($_POST["MM_settings"] == "form5")) {
		  ...
		  if($Result1) {
				...
				echo ("<font id='tamam'> Site ayarlarını g&uuml;ncelleme işleminiz tamamlandı!</font>");
		    }
			else {
  ...
  $(document).ready(function(){
    $("#form1").validate();
			...
			echo " checked='checked'"; else echo ""; ?>/>
                      ...
                      <ul>
                        <li> Seçenek aktif olduğu halde istediğiniz gözükmüyor ise, yönetici bu seçeneği kapatmış olabilir. </li>
                        <li> Bazı değişikliklerin etkin olabilmesi için sayfayı yenilemeniz gerekebilir. </li>
                        <li> Bazı değişiklikler ile sitenin çalışma hızı artabilir; sık kullanmadığınız özellikler yer kaplamaz. </li>
                      </ul>
                    </div>
                    <div class="cleared"></div>
                  </div>
