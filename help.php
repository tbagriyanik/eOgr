...
?>
	...
	if (md5($_SERVER['HTTP_USER_AGENT']) != $_SESSION['aThing']) {   
	   sessionDestroy();
		die("<font id='hata'> Oturum a&ccedil;ma hatası meydana geldi.</font>"); //session?
		exit;
	}
...
?>
                  <div id="menu">
                    ...
                    <ul>
                      ...
                      <li>Ders Kısıtlamaları</li>
                      <li>&Ouml;ğrenci İşlerini Takip Etmek</li>
                      <li>Ders &Ccedil;alışma</li>
                      <li>Kullanıcı Se&ccedil;enekleri</li>
                      <li>G&uuml;venlik Tavsiyeleri</li>
                      <li>Sık Sorulan Sorular (Nasıl Yapılır?)</li>
                      <li>İpu&ccedil;ları ve Sorun Giderme</li>
                      <li>Bildiriler ve Teşekk&uuml;rler</li>
                    </ul>
                  </div>
